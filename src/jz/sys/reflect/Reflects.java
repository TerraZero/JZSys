...
import jz.sys.reflect.api.ReflectDefaultInterface;
import jz.sys.reflect.api.ReflectInterface;
 ...
 *
 */
@SysComponent(name="Reflect")
public class Reflects {
	
	private static ReflectInterface handling;
	
	static {
		Reflects.handling = new ReflectDefaultInterface();
	}
	
	public static void setReflectInterface(ReflectInterface handling) {
		Reflects.handling = handling;
	}
	
	public static ReflectInterface getReflectInterface() {
		return Reflects.handling;
	}
